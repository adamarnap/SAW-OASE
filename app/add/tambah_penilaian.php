...
$query = mysqli_query($koneksi,"INSERT INTO tb_penilaian (id_penilaian,alternatif,kemampuan_kerjasama,presensi,kedisiplinan,penjualan,lembur) VALUES(0,'$alternatif','$kemampuan_kerjasama','$presensi','$kedisiplinan','$penjualan','$lembur')");

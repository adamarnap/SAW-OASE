<?php  
  ...
  if (isset($_POST['hitung'])) {
    ...
    if ($isiPenilai[0] == 0) {
      ...
      function normalisasi($r11, $r21, $r31, $r41, $r51) {
        global $koneksi;
      ...
      // Ambil jumlah banyaknya karyawan di implementasikan ke dalam normalisasi
      $data_karyawan = tampilData("SELECT alternatif FROM tb_penilaian");
      
      foreach ($data_karyawan as $key => $value) {
        normalisasi($ambil[$key][2], $ambil[$key][3], $ambil[$key][4], $ambil[$key][5], $ambil[$key][6]);
      }
      ...
      function preferensi($id,$r11, $r21, $r31, $r41, $r51) {
        global $koneksi;
        global $bobotK1;
        global $bobotK2;
        global $bobotK3;
      ...
      foreach ($data_karyawan as $key => $value) {
         preferensi($penilaian [$key]['id_penilaian'],$hasilNorm[$key][1], $hasilNorm[$key][2], $hasilNorm[$key][3], $hasilNorm[$key][4], $hasilNorm[$key][5]);
      }
